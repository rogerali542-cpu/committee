...
module.exports = {
  ...
  ownerMeetings: [
    { id: 1, title: '2026年度第一次业主大会', meetingDate: '2026-07-20', meetingTime: '14:00', location: '小区中心广场', type: 'regular', stage: 'preparing', compliance: null, needsVote: true, statusLine: '通知进度 0/10 户' },
    { id: 2, title: '2025年临时业主大会（物业更换）', meetingDate: '2025-09-20', meetingTime: '10:00', location: '小区会议室', type: 'special', stage: 'ended', compliance: 'valid', needsVote: true, statusLine: '已公示（2025-09-22）', _materials: [ { name: '业主投票表决统计表.pdf', sizeText: '1.5MB', content: '各楼栋投票与面积统计明细……' }, { name: '新物业服务方案.pdf', sizeText: '2.1MB', content: '拟更换物业公司服务方案与报价……' } ] },
    { id: 3, title: '2025年度第一次业主大会', meetingDate: '2025-05-10', meetingTime: '09:00', location: '小区活动广场', type: 'regular', stage: 'ended', compliance: 'invalid', needsVote: true, statusLine: '会议未成立' },
    { id: 4, title: '2026年小区年度工作通报会', meetingDate: '2026-08-15', meetingTime: '19:00', location: '小区文化活动中心', type: 'regular', stage: 'preparing', compliance: null, needsVote: false, statusLine: '无需表决' },
    { id: 5, title: '2026年物业续聘表决大会', meetingDate: '2026-06-20', meetingTime: '10:00', location: '小区中心广场', type: 'special', stage: 'ongoing', compliance: null, needsVote: true, notify: { sent: 10, announced: true, contentComplete: true }, ballot: { delivered: 10, records: false, nonFaceAnnounce: false }, statusLine: '进行中...',
      record: { presentOwners: 6, presentArea: 560, supervisorName: '街道办李主任', supervisorSigned: false, process: { designated: true, monitor: false, callout: false, tally: false },
        topics: [
          { id: 1, title: '是否续聘现有物业公司', type: 'ordinary', forOwners: 2, agOwners: 1, abOwners: 0, forArea: 180, agArea: 92, abArea: 0 },
          { id: 2, title: '物业费调整方案', type: 'major', forOwners: 1, agOwners: 0, abOwners: 0, forArea: 105, agArea: 0, abArea: 0 }
        ], evidence: [] }
    }
  ],

  ownerStats: { annualCount: 0, specialCount: 1, preparing: 2, ongoing: 0, ended: 2 },
  ...
  // 房屋花名册（按户，不作通知送达追踪，仅计票用）
  // 每户一个代表人 representativeUserId → user_role_id
  housingUnits: [
    { id: 1,  building: '1栋', unitNo: '101', area: 92.50,  ownerUserIds: [9], representativeUserId: 9 },
    { id: 2,  building: '1栋', unitNo: '102', area: 92.50,  ownerUserIds: [8], representativeUserId: 8 },
    { id: 3,  building: '1栋', unitNo: '201', area: 95.00,  ownerUserIds: [7], representativeUserId: 7 },
    { id: 4,  building: '1栋', unitNo: '202', area: 95.00,  ownerUserIds: [6], representativeUserId: 6 },
    { id: 5,  building: '2栋', unitNo: '101', area: 88.00,  ownerUserIds: [5], representativeUserId: 5 },
    { id: 6,  building: '2栋', unitNo: '102', area: 88.00,  ownerUserIds: [4], representativeUserId: 4 },
    { id: 7,  building: '2栋', unitNo: '201', area: 92.00,  ownerUserIds: [3], representativeUserId: 3 },
    { id: 8,  building: '2栋', unitNo: '202', area: 92.00,  ownerUserIds: [2], representativeUserId: 2 },
    { id: 9,  building: '3栋', unitNo: '101', area: 105.00, ownerUserIds: [1, 11], representativeUserId: 1 },
    { id: 10, building: '3栋', unitNo: '102', area: 105.00, ownerUserIds: [1], representativeUserId: 1 }
  ]
};
