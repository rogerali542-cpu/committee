...
.login-sub { font-size: 32rpx; color: rgba(255,255,255,0.9); margin-top: 10rpx; }
...
.role-tag { font-size: 26rpx; color: #FFA800; background: #FFF6E5; padding: 2rpx 12rpx; border-radius: 16rpx; margin-left: 8rpx; }
.role-desc { font-size: 26rpx; color: #666; margin-top: 6rpx; }
.role-arrow { color: #5f636b; font-size: 40rpx; }
</style>
