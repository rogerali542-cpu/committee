...
.intro { font-size: 28rpx; color: #666; display: block; margin-bottom: 24rpx; text-align: center; }
...
.section-count { font-size: 28rpx; color: #C77800; background: #FFF3DC; border-radius: 14rpx; padding: 4rpx 16rpx; font-weight: 600; }
