...
.field-label { font-size: 32rpx; color: #666; width: 140rpx; flex-shrink: 0; line-height: 1.5; }
.field-val { font-size: 32rpx; color: #1f2329; flex: 1; line-height: 1.5; }
.field-val.tag { font-size: 32rpx; font-weight: 600; padding: 4rpx 18rpx; border-radius: 10rpx; display: inline-block; width: auto; flex: none; }
...
.pr-label { font-size: 32rpx; color: #666; }
...
.cc-label { font-size: 32rpx; color: #666; display: block; margin-bottom: 12rpx; }
...
.sign-title { font-size: 32rpx; font-weight: 700; color: #1f2329; }
.sign-stat { font-size: 32rpx; color: #C77800; font-weight: 600; }
...
.sign-name { font-size: 32rpx; color: #1f2329; }
.sign-status { font-size: 32rpx; font-weight: 600; }
...
.btn-signin { width: 100%; height: 84rpx; line-height: 84rpx; border-radius: 42rpx; background: #fff; color: #C77800; border: 2rpx solid #FFA800; font-size: 32rpx; font-weight: 600; margin: 0; }
...
.ev-title { font-size: 32rpx; font-weight: 700; color: #1f2329; }
.ev-add { font-size: 32rpx; color: #C77800; font-weight: 600; }
.ev-list { display: flex; flex-direction: column; gap: 8rpx; }
.ev-item { display: flex; align-items: center; justify-content: space-between; gap: 16rpx; padding: 16rpx 18rpx; background: #fafbfc; border-radius: 12rpx; font-size: 32rpx; color: #444; }
...
.ev-empty { font-size: 32rpx; color: #777; text-align: center; padding: 16rpx 0; }
...
.ac-hint { font-size: 32rpx; color: #666; display: block; margin-bottom: 20rpx; }
...
/* 无权限 / 已完成 */
.perm-note { background: #FFF8E8; border: 2rpx solid #FFE0A3; border-radius: 18rpx; padding: 20rpx 24rpx; margin-bottom: 20rpx; font-size: 32rpx; color: #9A7600; text-align: center; }
...
.delete-link { font-size: 32rpx; color: #E74C3C; }

/* 复用 */
.empty-state { padding: 80rpx; text-align: center; color: #777; font-size: 32rpx; }
.stage-pill { font-size: 32rpx; font-weight: 600; padding: 6rpx 18rpx; border-radius: 12rpx; white-space: nowrap; }
