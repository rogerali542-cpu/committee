...
.hd { display: flex; align-items: flex-end; justify-content: space-between; padding: calc(env(safe-area-inset-top) + 14rpx) 32rpx 18rpx; background: #2b5589; }   /* 印章页头＝蓝（用户定，规范三色制借色） */
